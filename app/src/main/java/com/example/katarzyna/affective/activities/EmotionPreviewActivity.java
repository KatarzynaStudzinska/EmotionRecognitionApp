...
/**
 * Created by katarzyna on 08.05.17.
 */

public class EmotionPreviewActivity extends Activity implements Detector.ImageListener, CameraDetector.CameraEventListener {

    final String LOG_TAG = "EmotionPreviewActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.emocion_preview_layout);

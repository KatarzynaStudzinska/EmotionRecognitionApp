package com.example.katarzyna.affective;
...
public class VideoPreview extends Activity implements Detector.ImageListener, CameraDetector.CameraEventListener {

    final String LOG_TAG = "VideoPreview";
